      ...
      <nav class="navbar navbar-expand-lg main-navbar">
        ...
        <ul class="navbar-nav navbar-right">
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
              ...
              <div class="d-sm-none d-lg-inline-block">Hi, Ade Anugerah</div>
            </a>
      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="nav-item{{ request()->is('kendaraan') ? ' active' : '' }}"><a href="{{ url('/kendaraan') }}"><i class='far fa-folder fa-9x' style='color:#000000'></i><span>Kendaraan</span></a></li>
            <li class="nav-item{{ request()->is('kwitansi') ? ' active' : '' }}"><a href="{{ url('/kwitansi') }}"><i class='fas fa-clipboard-list fa-9x' style='color:#000000'></i><span>Kwitansi</span></a></li>
            <li class="nav-item{{ request()->is('invoices') ? ' active' : '' }}"><a href="{{ url('/invoices') }}"><i class="fas fa-chalkboard-teacher"></i><span>Invoices</span></a></li>
          </ul>
            </li>
          </ul>
